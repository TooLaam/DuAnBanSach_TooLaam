...
public class DM_TinhLuong {
    ...
    public DM_TinhLuong(String idLuong, String idNV, String maNV, int thang, int second, BigDecimal tongTienPhat, BigDecimal tongTienThuong, BigDecimal mucLuong, BigDecimal tongTienCong, BigDecimal tongLuong) {
        this.idLuong = idLuong;
        this.idNV = idNV;
        this.maNV = maNV;
        this.thang = thang;

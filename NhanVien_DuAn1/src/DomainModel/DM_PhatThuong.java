 ...
 * @author DELL
 */
public class DM_PhatThuong {
    private String lyDoThuong,lyDoPhat,idThuong,idPhat,idNV,ngayTao;
    private BigDecimal mucPhat,mucThuong;
    private int trangThai;

    public DM_PhatThuong(String lyDoThuong, String lyDoPhat, String idThuong, String idPhat, String idNV, String ngayTao, BigDecimal mucPhat, BigDecimal mucThuong, int trangThai) {

...
public class VM_ThongKe {
    ...
    public VM_ThongKe(String ngayBD, String ngayKT, String maNV, String maSP, String tenSP, int SLBan, BigDecimal doanhThuTheoSP, int tongSPBan, BigDecimal tongDoanhThuBan, int tongHDBan) {
        this.ngayBD = ngayBD;
        this.ngayKT = ngayKT;
        this.maNV = maNV;
        this.maSP = maSP;
    ...
    public VM_ThongKe(int tongSoNV, int tongSoNamNu, int tongSoNam, int tongSoDangLam, int tongSoTamNghi, int tongSoNghi, int tongSoCoTheGiaoHang, int tongSoKhongTheGiaoHang) {
        this.tongSoNV = tongSoNV;
        this.tongSoNamNu = tongSoNamNu;
        this.tongSoNam = tongSoNam;
        this.tongSoDangLam = tongSoDangLam;
